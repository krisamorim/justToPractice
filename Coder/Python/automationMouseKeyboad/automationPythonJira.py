...
time.sleep(1)
pyautogui.press(['tab'])
pyautogui.write('Mapeamento/revisao e definicao de execucao de sequencia de dev')
pyautogui.press(['tab', 'tab', 'tab'])
time.sleep(1)
pyautogui.write('3')
pyautogui.press(['tab', 'tab'])
...
####Add Registro de preparar report varela na Sexta
#clicar no vazio da coluna da quinta
pyautogui.click(x=1207, y=1014)
time.sleep(1)
#clicar no botão add tarefa
pyautogui.click(x=1149, y=701)
time.sleep(2)
pyautogui.write('12404')
time.sleep(4)
pyautogui.press(['enter'])
time.sleep(1)
pyautogui.press(['tab'])
pyautogui.write('preparar report varela')
pyautogui.press(['tab', 'tab', 'tab'])
time.sleep(1)
pyautogui.write('3')
pyautogui.press(['tab', 'tab'])
pyautogui.write('apresent')
time.sleep(2)
pyautogui.press(['enter'])
time.sleep(1)
pyautogui.press(['tab', 'tab', 'enter'])

####Add Registro de analisar material de requisito na Sexta
#clicar no vazio da coluna da quinta
pyautogui.click(x=1207, y=1014)
time.sleep(1)
#clicar no botão add tarefa
pyautogui.click(x=1153, y=806)
time.sleep(2)
pyautogui.write('12404')
time.sleep(4)
pyautogui.press(['enter'])
time.sleep(1)
pyautogui.press(['tab'])
pyautogui.write('analisar material de requisit')
pyautogui.press(['tab', 'tab', 'tab'])
time.sleep(1)
pyautogui.write('4')
pyautogui.press(['tab', 'tab'])
